...
- [Common pseudocode structures](#common-pseudocode-structures)
- [R is](#r-is)
- [How to run R-language software](#how-to-run-r-language-software)
- [What is RStudio?](#what-is-rstudio)
- [Installing R and RStudio](#installing-r-and-rstudio)
- [Basic R coding](#basic-r-coding)
- [:rotating_light: **D**on't **R**epeat **Y**ourself](#rotating_light-dont-repeat-yourself)
- [Don't overthink this, though](#dont-overthink-this-though)
- [Basic operators](#basic-operators)
- [Logical operators](#logical-operators)
- [Subsetting](#subsetting)
- [Basic, general-purpose R functions](#basic-general-purpose-r-functions)
- [Getting offline help](#getting-offline-help)
- [Basic statistical functions](#basic-statistical-functions)
- [Linear regression](#linear-regression)
- [A more interesting linear regression](#a-more-interesting-linear-regression)
- [Picking up from yesterday](#picking-up-from-yesterday)
- [A couple extra exercises](#a-couple-extra-exercises)
- [Working with packages](#working-with-packages)
- [Reading data](#reading-data)
- [Saving data](#saving-data)
- [Treating data](#treating-data)
- [Analysing data](#analysing-data)
- [Scripting](#scripting)
- [What is a "working directory"? Where is my stuff?](#what-is-a-working-directory-where-is-my-stuff)
- [Writing functions](#writing-functions)
- [Controlling flow](#controlling-flow)
- [Debugging](#debugging)
- [Profiling](#profiling)
- [Useful printing functions for writing functions (:zany_face:)](#useful-printing-functions-for-writing-functions-zany_face)
