...
- <img src="img/linux.png" height=20> use your distribution's package manager (apt, dnf, yum, pacman...)
- <img src="img/apple.png" height=20> use your app store or [Homebrew](https://brew.sh/)
-  <img src="img/windows.png" height=20> download [Make for Windows](http://gnuwin32.sourceforge.net/packages/make.htm) or use [Chocolatey](https://chocolatey.org/packages/make)
